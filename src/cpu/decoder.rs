...
pub fn decode_opcode(opcode: u8) -> (Instructions, AddressingMode, u8, u8, CycleOops) {
	...
	match opcode {
		...
		0x70 => (Instructions::BVS, AddressingMode::RELATIVE, 		2, 2, CycleOops::BranchOccursOn),
		0x71 => (Instructions::ADC, AddressingMode::INDIRECTY, 		2, 5, CycleOops::PageBoundryCrossed),
		0x75 => (Instructions::ADC, AddressingMode::ZEROPAGEX, 		2, 4, CycleOops::NONE),
		0x76 => (Instructions::ROR, AddressingMode::ZEROPAGEX, 		2, 6, CycleOops::NONE),
		0x78 => (Instructions::SEI, AddressingMode::IMPLIED, 		1, 2, CycleOops::NONE),
		0x79 => (Instructions::ADC, AddressingMode::ABSOLUTEY, 		3, 4, CycleOops::PageBoundryCrossed),
		0x7D => (Instructions::ADC, AddressingMode::ABSOLUTEX, 		3, 4, CycleOops::PageBoundryCrossed),
		0x7E => (Instructions::ROR, AddressingMode::ABSOLUTEX, 		3, 7, CycleOops::NONE),
		0x81 => (Instructions::STA, AddressingMode::INDIRECTX, 		2, 6, CycleOops::NONE),
		0x84 => (Instructions::STY, AddressingMode::ZEROPAGE, 		2, 3, CycleOops::NONE),
		0x85 => (Instructions::STA, AddressingMode::ZEROPAGE, 		2, 3, CycleOops::NONE),
		0x86 => (Instructions::STX, AddressingMode::ZEROPAGE, 		2, 3, CycleOops::NONE),
		0x88 => (Instructions::DEY, AddressingMode::IMPLIED, 		1, 2, CycleOops::NONE),
		0x8A => (Instructions::TXA, AddressingMode::IMPLIED, 		1, 2, CycleOops::NONE),
		0x8C => (Instructions::STY, AddressingMode::ABSOLUTE, 		3, 4, CycleOops::NONE),
		...
		0xA4 => (Instructions::LDY, AddressingMode::ZEROPAGE, 		2, 3, CycleOops::NONE),
		...
		0xAC => (Instructions::LDY, AddressingMode::ABSOLUTE, 		3, 4, CycleOops::NONE),
		...
		0xB4 => (Instructions::LDY, AddressingMode::ZEROPAGEX, 		2, 4, CycleOops::NONE),
